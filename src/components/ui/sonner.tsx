  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            'group rounded-2xl toast group-[.toaster]:bg-cardBg  group-[.toaster]:text-white group-[.toaster]:border-neutral-200 group-[.toaster]:shadow-lg dark:group-[.toaster]:bg-neutral-950 dark:group-[.toaster]:text-neutral-50 dark:group-[.toaster]:border-neutral-800',
